...
Total=NULL
for (i in 1:nrow(data01)){
  Sev_Total[i]=(data01$Sev_Damage[i]+data01$Sev_Fire[i]+data01$Sev_Theft[i]+data01$Sev_Other[i]+data01$Sev_TPL[i]+data01$Sev_Windscreen[i])/sum(data01[i,14:19]!=0)
...
RMSE_y_hat_Windscreen_Gamma=sqrt(MSE_y_hat_Windscreen_Gamma)
RMSE_y_hat_Windscreen_Gamma
#MAPE_y_hat_Windscreen_Gamma=1/nrow(data_testing_sev_subset)*sum(abs((data_testing_sev_subset$Sev_Windscreen-y_hat_Windscreen_Gamma)/data_testing_sev_subset$Sev_Windscreen))
#MAPE_y_hat_Windscreen_Gamma
...
RMSE_y_hat_Windscreen_Gaussian=sqrt(MSE_y_hat_Windscreen_Gaussian)
RMSE_y_hat_Windscreen_Gaussian
...
RMSE_y_hat_Windscreen_Gaussian_log=sqrt(MSE_y_hat_Windscreen_Gaussian_log)
RMSE_y_hat_Windscreen_Gaussian_log
...
RMSE_y_hat_Windscreen_Inverse_Gaussian=sqrt(MSE_y_hat_Windscreen_Inverse_Gaussian)
#-----------------------------------------------------------------------------------------------------------------------
...
RMSE_copula_windscreen_testing=sqrt(MSE_copula_Windscreen_testing)
...
RMSE_copula_Windscreen_testing_beta=sqrt(MSE_copula_Windscreen_testing_beta)
...
RMSE_copula_Windscreen_testing_inv_gaussian=sqrt(MSE_copula_Windscreen_testing_inv_gaussian)
...
RMSE_copula_Windscreen_testing_inv_gaussian_beta=sqrt(MSE_copula_Windscreen_testing_inv_gaussian_beta)

#MAPE Windscreen untuk yang tidak ada sensor
besarklaim_windscreen=data.frame(cbind(data_testing_sev_subset$Sev_Windscreen,y_hat_Windscreen_Gamma,y_hat_Windscreen_Gaussian,y_hat_Windscreen_Gaussian_log,y_hat_Windscreen_Inverse_Gaussian,mean_testing_inv_gaussian,mean_testing_inv_gaussian_beta))
filtered_besarklaim_Windscreen_MAPE=subset(besarklaim_windscreen,besarklaim_windscreen$V1!=0)

MAPE_Windscreen_Gamma=sum(abs((filtered_besarklaim_Windscreen_MAPE$V1-filtered_besarklaim_Windscreen_MAPE$y_hat_Windscreen_Gamma)/filtered_besarklaim_Windscreen_MAPE$V1))*(1/nrow(filtered_besarklaim_Windscreen_MAPE))
MAPE_Windscreen_Gamma

MAPE_Windscreen_Gaussian=sum(abs((filtered_besarklaim_Windscreen_MAPE$V1- filtered_besarklaim_Windscreen_MAPE$y_hat_Windscreen_Gaussian)/filtered_besarklaim_Windscreen_MAPE$V1))*(1/nrow(filtered_besarklaim_Windscreen_MAPE))
MAPE_Windscreen_Gaussian

MAPE_Windscreen_Gaussian_Log=sum(abs((filtered_besarklaim_Windscreen_MAPE$V1-filtered_besarklaim_Windscreen_MAPE$y_hat_Windscreen_Gaussian_log)/filtered_besarklaim_Windscreen_MAPE$V1))*(1/nrow(filtered_besarklaim_Windscreen_MAPE))
MAPE_Windscreen_Gaussian_Log

MAPE_Windscreen_InvGaussian_Log=sum(abs((filtered_besarklaim_Windscreen_MAPE$V1-filtered_besarklaim_Windscreen_MAPE$y_hat_Windscreen_Inverse_Gaussian)/filtered_besarklaim_Windscreen_MAPE$V1))*(1/nrow(filtered_besarklaim_Windscreen_MAPE))
MAPE_Windscreen_InvGaussian_Log

MAPE_Windscreen_copula_Inv_Gauss=sum(abs((filtered_besarklaim_Windscreen_MAPE$V1-filtered_besarklaim_Windscreen_MAPE$mean_testing_inv_gaussian)/filtered_besarklaim_Windscreen_MAPE$V1))*(1/nrow(filtered_besarklaim_Windscreen_MAPE))
MAPE_Windscreen_copula_Inv_Gauss

MAPE_Windscreen_copula_Inv_Gauss_beta=sum(abs((filtered_besarklaim_Windscreen_MAPE$V1-filtered_besarklaim_Windscreen_MAPE$mean_testing_inv_gaussian_beta)/filtered_besarklaim_Windscreen_MAPE$V1))*(1/nrow(filtered_besarklaim_Windscreen_MAPE))
MAPE_Windscreen_copula_Inv_Gauss_beta

#MAPE besar klaim windscreen untuk data sensor 
besarklaim_windscreen01=data.frame(cbind(data_testing_sev_subset01$Sev_Windscreen,mean_testing01,mean_testing_beta01))
filtered_besarklaim_Windscreen_MAPE01=subset(besarklaim_windscreen01,besarklaim_windscreen01$V1!=0)

MAPE_Windscreen_copula_Normal=sum(abs((filtered_besarklaim_Windscreen_MAPE01$V1-filtered_besarklaim_Windscreen_MAPE01$mean_testing01)/filtered_besarklaim_Windscreen_MAPE01$V1))*(1/nrow(filtered_besarklaim_Windscreen_MAPE01))
MAPE_Windscreen_copula_Normal

MAPE_Windscreen_copula_Normal_beta=sum(abs((filtered_besarklaim_Windscreen_MAPE01$V1-filtered_besarklaim_Windscreen_MAPE01$mean_testing_beta01)/filtered_besarklaim_Windscreen_MAPE01$V1))*(1/nrow(filtered_besarklaim_Windscreen_MAPE01))
MAPE_Windscreen_copula_Normal_beta
...
RMSE_Windscreen_GammaPoisson=sqrt(MSE_Windscreen_GammaPoisson)
...
RMSE_WIndscreen_GaussianPoisson=sqrt(MSE_WIndscreen_GaussianPoisson)
...
RMSE_WIndscreen_GaussianPoisson_log=sqrt(MSE_WIndscreen_GaussianPoisson_log)
...
RMSE_Windscreen_InverseGaussianPoisson=sqrt(MSE_Windscreen_InverseGaussianPoisson)
...
RMSE_Windscreen_InverseGaussianPoisson_copula=sqrt(MSE_Windscreen_InverseGaussianPoisson_copula)
...
RMSE_Windscreen_InverseGaussianPoisson_copula_beta=sqrt(MSE_Windscreen_InverseGaussianPoisson_copula_beta)
...
RMSE_Windscreen_GaussianPoisson_copula=sqrt(MSE_Windscreen_GaussianPoisson_copula)
...
RMSE_Windscreen_GaussianPoisson_copula_beta=sqrt(MSE_Windscreen_GaussianPoisson_copula_beta)


# MAPE Premi Murni Windscreen  
PremiMurni_Windscreen=data.frame(cbind(S_windscreen,pure_prem_GammaPoisson ,pure_prem_GaussianPoisson,pure_prem_GaussianPoisson_log,
...
filtered_PremiMurni_Windscreen_MAPE=subset(PremiMurni_Windscreen,PremiMurni_Windscreen$S_windscreen!=0)

MAPE_PremiMurni_Windscreen_Gamma=sum(abs((filtered_PremiMurni_Windscreen_MAPE$S_windscreen-filtered_PremiMurni_Windscreen_MAPE$pure_prem_GammaPoisson)/filtered_PremiMurni_Windscreen_MAPE$S_windscreen))*(1/nrow(filtered_PremiMurni_Windscreen_MAPE))
MAPE_PremiMurni_Windscreen_Gamma

MAPE_PremiMurni_Windscreen_Gaussian=sum(abs((filtered_PremiMurni_Windscreen_MAPE$S_windscreen-filtered_PremiMurni_Windscreen_MAPE$pure_prem_GaussianPoisson)/filtered_PremiMurni_Windscreen_MAPE$S_windscreen))*(1/nrow(filtered_PremiMurni_Windscreen_MAPE))
MAPE_PremiMurni_Windscreen_Gaussian

MAPE_PremiMurni_Windscreen_Gaussian_Log=sum(abs((filtered_PremiMurni_Windscreen_MAPE$S_windscreen-filtered_PremiMurni_Windscreen_MAPE$pure_prem_GaussianPoisson_log)/filtered_PremiMurni_Windscreen_MAPE$S_windscreen))*(1/nrow(filtered_PremiMurni_Windscreen_MAPE))
MAPE_PremiMurni_Windscreen_Gaussian_Log

MAPE_PremiMurni_Windscreen_InvGaussian=sum(abs((filtered_PremiMurni_Windscreen_MAPE$S_windscreen-filtered_PremiMurni_Windscreen_MAPE$pure_prem_InverseGaussianPoisson)/filtered_PremiMurni_Windscreen_MAPE$S_windscreen))*(1/nrow(filtered_PremiMurni_Windscreen_MAPE))
MAPE_PremiMurni_Windscreen_InvGaussian

MAPE_PremiMurni_Windscreen_Normal_Copula=sum(abs((filtered_PremiMurni_Windscreen_MAPE$S_windscreen-filtered_PremiMurni_Windscreen_MAPE$pure_prem_GaussianPoisson_copula)/filtered_PremiMurni_Windscreen_MAPE$S_windscreen))*(1/nrow(filtered_PremiMurni_Windscreen_MAPE))
MAPE_PremiMurni_Windscreen_Normal_Copula

MAPE_PremiMurni_Windscreen_NormalBeta_Copula=sum(abs((filtered_PremiMurni_Windscreen_MAPE$S_windscreen-filtered_PremiMurni_Windscreen_MAPE$pure_prem_GaussianPoisson_copula_beta)/filtered_PremiMurni_Windscreen_MAPE$S_windscreen))*(1/nrow(filtered_PremiMurni_Windscreen_MAPE))
MAPE_PremiMurni_Windscreen_NormalBeta_Copula

MAPE_PremiMurni_Windscreen_InvGauss_Copula=sum(abs((filtered_PremiMurni_Windscreen_MAPE$S_windscreen-filtered_PremiMurni_Windscreen_MAPE$pure_prem_InverseGaussianPoisson_copula)/filtered_PremiMurni_Windscreen_MAPE$S_windscreen))*(1/nrow(filtered_PremiMurni_Windscreen_MAPE))
MAPE_PremiMurni_Windscreen_InvGauss_Copula

MAPE_PremiMurni_Windscreen_InvGauss_Copula_Beta=sum(abs((filtered_PremiMurni_Windscreen_MAPE$S_windscreen-filtered_PremiMurni_Windscreen_MAPE$pure_prem_InverseGaussianPoisson_copula_beta)/filtered_PremiMurni_Windscreen_MAPE$S_windscreen))*(1/nrow(filtered_PremiMurni_Windscreen_MAPE))
MAPE_PremiMurni_Windscreen_InvGauss_Copula_Beta
...
ggplot(df_premi_murni_windscreen, aes(x = Model, y = Predicted_Values)) +
  ...
  geom_text(data = mean_premi_murni_windscreen, aes(x = Model, y = Predicted_Values, label = round(Predicted_Values, 2)),
            vjust = -0.5, hjust = 0.5, size = 5, col = "black")+
  labs(title = "Boxplot Premi Murni Windscreen", 
       x = "Models", y = "Predicted Values") +
  scale_y_continuous(expand = c(0.1, 0))+
  theme(axis.text.x = element_text(angle = 60, hjust = 1,size = 15))+scale_y_continuous(limits = c(0,400))
...
MSE_TPL_Gamma
RMSE_TPL_Gamma=sqrt(MSE_TPL_Gamma)
...
MSE_TPL_Gaussian
RMSE_TPL_Gaussian=sqrt(MSE_TPL_Gaussian)
...
RMSE_TPL_InverseGaussian=sqrt(MSE_TPL_InverseGaussian)
...
RMSE_copula_TPL_testing_inv_gaussian=sqrt(MSE_copula_TPL_testing_inv_gaussian)

#MAPE TPL besar klaim

besarklaim_TPL=data.frame(cbind(data_testing_sev_subset_TPL$Sev_TPL, y_hat_TPL_Gamma,y_hat_TPL_Gaussian,y_hat_TPL_Gaussian_log,y_hat_TPL_Inverse_Gaussian,mean_testing_inv_gaussian_TPL))
filtered_besarklaim_TPL_MAPE=subset(besarklaim_TPL,besarklaim_TPL$V1!=0)

MAPE_TPL_Gamma=sum(abs((filtered_besarklaim_TPL_MAPE$V1-filtered_besarklaim_TPL_MAPE$y_hat_TPL_Gamma)/filtered_besarklaim_TPL_MAPE$V1))*(1/nrow(filtered_besarklaim_TPL_MAPE))
MAPE_TPL_Gamma

MAPE_TPL_Gaussian=sum(abs((filtered_besarklaim_TPL_MAPE$V1- filtered_besarklaim_TPL_MAPE$y_hat_TPL_Gaussian)/filtered_besarklaim_TPL_MAPE$V1))*(1/nrow(filtered_besarklaim_TPL_MAPE))
MAPE_TPL_Gaussian

MAPE_TPL_Gaussian_Log=sum(abs((filtered_besarklaim_TPL_MAPE$V1-filtered_besarklaim_TPL_MAPE$y_hat_TPL_Gaussian_log)/filtered_besarklaim_TPL_MAPE$V1))*(1/nrow(filtered_besarklaim_TPL_MAPE))
MAPE_TPL_Gaussian_Log

MAPE_TPL_InvGaussian_Log=sum(abs((filtered_besarklaim_TPL_MAPE$V1-filtered_besarklaim_TPL_MAPE$y_hat_TPL_Inverse_Gaussian)/filtered_besarklaim_TPL_MAPE$V1))*(1/nrow(filtered_besarklaim_TPL_MAPE))
MAPE_TPL_InvGaussian_Log

MAPE_TPL_copula_InvGaussian=sum(abs((filtered_besarklaim_TPL_MAPE$V1-filtered_besarklaim_TPL_MAPE$mean_testing_inv_gaussian_TPL)/filtered_besarklaim_TPL_MAPE$V1))*(1/nrow(filtered_besarklaim_TPL_MAPE))
MAPE_TPL_copula_InvGaussian
...
RMSE_TPL_GammaPoisson=sqrt(MSE_TPL_GammaPoisson)
...
RMSE_TPL_GaussianPoisson=sqrt(MSE_TPL_GaussianPoisson)
...
RMSE_TPL_GaussianPoisson_log=sqrt(MSE_TPL_GaussianPoisson_log)
...
RMSE_TPL_InverseGaussianPoisson=sqrt(MSE_TPL_InverseGaussianPoisson)

MSE_TPL_copula=sum((S_TPL-pure_prem_copula_TPL)^2)/nrow(data_testing_sev_subset_TPL)
MSE_TPL_copula
RMSE_TPL_copula=sqrt(MSE_TPL_copula)

# MAPE Premi Murni TPL 
PremiMurni_TPL=data.frame(cbind(S_TPL,pure_prem_GammaPoisson_TPL ,pure_prem_GaussianPoisson_TPL,pure_prem_GaussianPoisson_TPL_log,
                                   pure_prem_InverseGaussianPoisson_TPL,pure_prem_copula_TPL))
filtered_PremiMurni_TPL_MAPE=subset(PremiMurni_TPL,PremiMurni_TPL$S_TPL!=0)

MAPE_PremiMurni_TPL_Gamma=sum(abs((filtered_PremiMurni_TPL_MAPE$S_TPL-filtered_PremiMurni_TPL_MAPE$pure_prem_GammaPoisson_TPL)/filtered_PremiMurni_TPL_MAPE$S_TPL))*(1/nrow(filtered_PremiMurni_TPL_MAPE))
MAPE_PremiMurni_TPL_Gamma

MAPE_PremiMurni_TPL_Gaussian=sum(abs((filtered_PremiMurni_TPL_MAPE$S_TPL-filtered_PremiMurni_TPL_MAPE$pure_prem_GaussianPoisson_TPL)/filtered_PremiMurni_TPL_MAPE$S_TPL))*(1/nrow(filtered_PremiMurni_TPL_MAPE))
MAPE_PremiMurni_TPL_Gaussian

MAPE_PremiMurni_TPL_Gaussian_Log=sum(abs((filtered_PremiMurni_TPL_MAPE$S_TPL-filtered_PremiMurni_TPL_MAPE$pure_prem_GaussianPoisson_TPL_log)/filtered_PremiMurni_TPL_MAPE$S_TPL))*(1/nrow(filtered_PremiMurni_TPL_MAPE))
MAPE_PremiMurni_TPL_Gaussian_Log

MAPE_PremiMurni_TPL_InvGaussian=sum(abs((filtered_PremiMurni_TPL_MAPE$S_TPL-filtered_PremiMurni_TPL_MAPE$pure_prem_InverseGaussianPoisson_TPL)/filtered_PremiMurni_TPL_MAPE$S_TPL))*(1/nrow(filtered_PremiMurni_TPL_MAPE))
MAPE_PremiMurni_TPL_InvGaussian

MAPE_PremiMurni_TPL_copula=sum(abs((filtered_PremiMurni_TPL_MAPE$S_TPL-filtered_PremiMurni_TPL_MAPE$pure_prem_copula_TPL)/filtered_PremiMurni_TPL_MAPE$S_TPL))*(1/nrow(filtered_PremiMurni_TPL_MAPE))
MAPE_PremiMurni_TPL_copula
...
RMSE_copula_damage_testing_inv_gaussian=sqrt(MSE_copula_damage_testing_inv_gaussian)
...
RMSE_copula_damage_testing_inv_gaussian_beta=sqrt(MSE_copula_damage_testing_inv_gaussian_beta)
...
MSE_Damage_Gamma
RMSE_Damage_Gamma=sqrt(MSE_Damage_Gamma)
...
MSE_Damage_Gaussian
RMSE_Damage_Gaussian=sqrt(MSE_Damage_Gaussian)
...
RMSE_Damage_Gaussian_log=sqrt(MSE_Damage_Gaussian_log)
...
RMSE_Damage_InverseGaussian=sqrt(MSE_Damage_InverseGaussian)

#MAPE Damage besar klaim

besarklaim_damage=data.frame(cbind(data_testing_sev_subset_Damage$Sev_Damage,y_hat_Damage_Gamma,y_hat_Damage_Gaussian,y_hat_Damage_Gaussian_log,y_hat_Damage_Inverse_Gaussian,
                                   mean_testing_inv_gaussian_damage, mean_testing_inv_gaussian_damage_beta))
filtered_besarklaim_damage_MAPE=subset(besarklaim_damage,besarklaim_damage$V1!=0)

MAPE_damage_Gamma=sum(abs((filtered_besarklaim_damage_MAPE$V1-filtered_besarklaim_damage_MAPE$y_hat_Damage_Gamma)/filtered_besarklaim_damage_MAPE$V1))*(1/nrow(filtered_besarklaim_damage_MAPE))
MAPE_damage_Gamma

MAPE_damage_Gaussian=sum(abs((filtered_besarklaim_damage_MAPE$V1-filtered_besarklaim_damage_MAPE$y_hat_Damage_Gaussian)/filtered_besarklaim_damage_MAPE$V1))*(1/nrow(filtered_besarklaim_damage_MAPE))
MAPE_damage_Gaussian


MAPE_damage_Gaussian_Log=sum(abs((filtered_besarklaim_damage_MAPE$V1-filtered_besarklaim_damage_MAPE$y_hat_Damage_Gaussian_log)/filtered_besarklaim_damage_MAPE$V1))*(1/nrow(filtered_besarklaim_damage_MAPE))
MAPE_damage_Gaussian_Log

MAPE_damage_InvGaussian=sum(abs((filtered_besarklaim_damage_MAPE$V1-filtered_besarklaim_damage_MAPE$y_hat_Damage_Inverse_Gaussian)/filtered_besarklaim_damage_MAPE$V1))*(1/nrow(filtered_besarklaim_damage_MAPE))
MAPE_damage_InvGaussian


MAPE_damage_copula_InvGaussian=sum(abs((filtered_besarklaim_damage_MAPE$V1-filtered_besarklaim_damage_MAPE$mean_testing_inv_gaussian_damage)/filtered_besarklaim_damage_MAPE$V1))*(1/nrow(filtered_besarklaim_damage_MAPE))
MAPE_damage_copula_InvGaussian

MAPE_damage_copula_InvGaussian_beta=sum(abs((filtered_besarklaim_damage_MAPE$V1-filtered_besarklaim_damage_MAPE$mean_testing_inv_gaussian_damage_beta)/filtered_besarklaim_damage_MAPE$V1))*(1/nrow(filtered_besarklaim_damage_MAPE))
MAPE_damage_copula_InvGaussian_beta
...
RMSE_Damage_GammaPoisson=sqrt(MSE_Damage_GammaPoisson)
...
RMSE_Damage_GaussianPoisson=sqrt(MSE_Damage_GaussianPoisson)
...
RMSE_Damage_GaussianPoisson_log=sqrt(MSE_Damage_GaussianPoisson_log)
...
RMSE_Damage_InverseGaussianPoisson=sqrt(MSE_Damage_InverseGaussianPoisson)
...
RMSE_Damage_InvGausPoisson_copula=sqrt(MSE_Damage_InvGausPoisson_copula)
...
RMSE_Damage_InvGausPoisson_copula_beta=sqrt(MSE_Damage_InvGausPoisson_copula_beta)

# MAPE Premi Murni Damage 
PremiMurni_damage=data.frame(cbind(S_Damage,pure_prem_GammaPoisson_damage ,pure_prem_GaussianPoisson_damage,pure_prem_GaussianPoisson_damage_log,
                                  pure_prem_InverseGaussianPoisson_damage,pure_prem_InvGaussPoisson_copula_damage,pure_prem_InvGaussPoisson_copula_damage_beta))
filtered_PremiMurni_Damage_MAPE=subset(PremiMurni_damage,PremiMurni_damage$S_Damage!=0)

MAPE_PremiMurni_Damage_Gamma=sum(abs((filtered_PremiMurni_Damage_MAPE$S_Damage-filtered_PremiMurni_Damage_MAPE$pure_prem_GammaPoisson_damage)/filtered_PremiMurni_Damage_MAPE$S_Damage))*(1/nrow(filtered_PremiMurni_Damage_MAPE))
MAPE_PremiMurni_Damage_Gamma

MAPE_PremiMurni_Damage_Gaussian=sum(abs((filtered_PremiMurni_Damage_MAPE$S_Damage-filtered_PremiMurni_Damage_MAPE$pure_prem_GaussianPoisson_damage)/filtered_PremiMurni_Damage_MAPE$S_Damage))*(1/nrow(filtered_PremiMurni_Damage_MAPE))
MAPE_PremiMurni_Damage_Gaussian

MAPE_PremiMurni_Damage_Gaussian_Log=sum(abs((filtered_PremiMurni_Damage_MAPE$S_Damage-filtered_PremiMurni_Damage_MAPE$pure_prem_GaussianPoisson_damage_log)/filtered_PremiMurni_Damage_MAPE$S_Damage))*(1/nrow(filtered_PremiMurni_Damage_MAPE))
MAPE_PremiMurni_Damage_Gaussian_Log

MAPE_PremiMurni_Damage_InvGaussian=sum(abs((filtered_PremiMurni_Damage_MAPE$S_Damage-filtered_PremiMurni_Damage_MAPE$pure_prem_InverseGaussianPoisson_damage)/filtered_PremiMurni_Damage_MAPE$S_Damage))*(1/nrow(filtered_PremiMurni_Damage_MAPE))
MAPE_PremiMurni_Damage_InvGaussian

MAPE_PremiMurni_Damage_InvGauss_copula=sum(abs((filtered_PremiMurni_Damage_MAPE$S_Damage-filtered_PremiMurni_Damage_MAPE$pure_prem_InvGaussPoisson_copula_damage)/filtered_PremiMurni_Damage_MAPE$S_Damage))*(1/nrow(filtered_PremiMurni_Damage_MAPE))
MAPE_PremiMurni_Damage_InvGauss_copula

MAPE_PremiMurni_Damage_InvGauss_copula_Beta=sum(abs((filtered_PremiMurni_Damage_MAPE$S_Damage-filtered_PremiMurni_Damage_MAPE$pure_prem_InvGaussPoisson_copula_damage_beta)/filtered_PremiMurni_Damage_MAPE$S_Damage))*(1/nrow(filtered_PremiMurni_Damage_MAPE))
MAPE_PremiMurni_Damage_InvGauss_copula_Beta
...
MSE_Other_Gamma
RMSE_Other_Gamma=sqrt(MSE_Other_Gamma)
...
MSE_Other_Gaussian
RMSE_Other_Gaussian=sqrt(MSE_Other_Gaussian)
...
RMSE_Other_Gaussian_log=sqrt(MSE_Other_Gaussian_log)
...
RMSE_Other_InverseGaussian=sqrt(MSE_Other_InverseGaussian)
...
RMSE_copula_other_testing_Normal=sqrt(MSE_copula_other_testing_Normal)
...
RMSE_copula_other_testing_inv_gaussian=sqrt(MSE_copula_other_testing_inv_gaussian)

#MAPE other besar klaim

besarklaim_other=data.frame(cbind(data_testing_Other_subset$Sev_Other,y_hat_Other_Gamma,y_hat_Other_Gaussian,y_hat_Other_Gaussian_log, y_hat_Other_Inverse_Gaussian,
                                  mean_testing_Normal_other,mean_testing_inv_gaussian_other))
filtered_besarklaim_other_MAPE=subset(besarklaim_other,besarklaim_other$V1!=0)

MAPE_other_Gamma=sum(abs((filtered_besarklaim_other_MAPE$V1-filtered_besarklaim_other_MAPE$y_hat_Other_Gamma)/filtered_besarklaim_other_MAPE$V1))*(1/nrow(filtered_besarklaim_other_MAPE))
MAPE_other_Gamma

MAPE_other_Gaussian=sum(abs((filtered_besarklaim_other_MAPE$V1-filtered_besarklaim_other_MAPE$y_hat_Other_Gaussian)/filtered_besarklaim_other_MAPE$V1))*(1/nrow(filtered_besarklaim_other_MAPE))
MAPE_other_Gaussian

MAPE_other_Gaussian_Log=sum(abs((filtered_besarklaim_other_MAPE$V1-filtered_besarklaim_other_MAPE$y_hat_Other_Gaussian_log)/filtered_besarklaim_other_MAPE$V1))*(1/nrow(filtered_besarklaim_other_MAPE))
MAPE_other_Gaussian_Log

MAPE_other_InvGauss=sum(abs((filtered_besarklaim_other_MAPE$V1-filtered_besarklaim_other_MAPE$y_hat_Other_Inverse_Gaussian)/filtered_besarklaim_other_MAPE$V1))*(1/nrow(filtered_besarklaim_other_MAPE))
MAPE_other_InvGauss

MAPE_other_copula_Normal=sum(abs((filtered_besarklaim_other_MAPE$V1-filtered_besarklaim_other_MAPE$mean_testing_Normal_other)/filtered_besarklaim_other_MAPE$V1))*(1/nrow(filtered_besarklaim_other_MAPE))
MAPE_other_copula_Normal

MAPE_other_copula_InvGauss=sum(abs((filtered_besarklaim_other_MAPE$V1-filtered_besarklaim_other_MAPE$mean_testing_inv_gaussian_other)/filtered_besarklaim_other_MAPE$V1))*(1/nrow(filtered_besarklaim_other_MAPE))
MAPE_other_copula_InvGauss
...
RMSE_other_GammaPoisson=sqrt(MSE_other_GammaPoisson)
...
RMSE_other_GaussianPoisson=sqrt(MSE_other_GaussianPoisson)
...
RMSE_other_GaussianPoisson_log=sqrt(MSE_other_GaussianPoisson_log)
...
RMSE_other_InverseGaussianPoisson=sqrt(MSE_other_InverseGaussianPoisson)
...
RMSE_other_InverseGaussianPoisson_copula=sqrt(MSE_other_InverseGaussianPoisson_copula)
...
RMSE_other_NormalPoisson_copula=sqrt(MSE_other_NormalPoisson_copula)

#MAPE Premi Murni Other 
PremiMurni_other=data.frame(cbind(S_other,pure_prem_GammaPoisson_other ,pure_prem_GaussianPoisson_other,pure_prem_GaussianPoisson_other_log,
                                  pure_prem_InverseGaussianPoisson_other,pure_prem_NormalPoisson_other_copula,pure_prem_InverseGaussianPoisson_other_copula))
filtered_PremiMurni_Other_MAPE=subset(PremiMurni_other,PremiMurni_other$S_other!=0)

MAPE_PremiMurni_Other_Gamma=sum(abs((filtered_PremiMurni_Other_MAPE$S_other-filtered_PremiMurni_Other_MAPE$pure_prem_GammaPoisson_other)/filtered_PremiMurni_Other_MAPE$S_other))*(1/nrow(filtered_PremiMurni_Other_MAPE))
MAPE_PremiMurni_Other_Gamma

MAPE_PremiMurni_Other_Gaussian=sum(abs((filtered_PremiMurni_Other_MAPE$S_other-filtered_PremiMurni_Other_MAPE$pure_prem_GaussianPoisson_other)/filtered_PremiMurni_Other_MAPE$S_other))*(1/nrow(filtered_PremiMurni_Other_MAPE))
MAPE_PremiMurni_Other_Gaussian

MAPE_PremiMurni_Other_Gaussian_Log=sum(abs((filtered_PremiMurni_Other_MAPE$S_other-filtered_PremiMurni_Other_MAPE$pure_prem_GaussianPoisson_other_log)/filtered_PremiMurni_Other_MAPE$S_other))*(1/nrow(filtered_PremiMurni_Other_MAPE))
MAPE_PremiMurni_Other_Gaussian_Log

MAPE_PremiMurni_Other_InvGaussian=sum(abs((filtered_PremiMurni_Other_MAPE$S_other-filtered_PremiMurni_Other_MAPE$pure_prem_InverseGaussianPoisson_other)/filtered_PremiMurni_Other_MAPE$S_other))*(1/nrow(filtered_PremiMurni_Other_MAPE))
MAPE_PremiMurni_Other_InvGaussian

MAPE_PremiMurni_Other_Normal_copula=sum(abs((filtered_PremiMurni_Other_MAPE$S_other-filtered_PremiMurni_Other_MAPE$pure_prem_NormalPoisson_other_copula)/filtered_PremiMurni_Other_MAPE$S_other))*(1/nrow(filtered_PremiMurni_Other_MAPE))
MAPE_PremiMurni_Other_Normal_copula

MAPE_PremiMurni_Other_InvGauss_copula=sum(abs((filtered_PremiMurni_Other_MAPE$S_other-filtered_PremiMurni_Other_MAPE$pure_prem_InverseGaussianPoisson_other_copula)/filtered_PremiMurni_Other_MAPE$S_other))*(1/nrow(filtered_PremiMurni_Other_MAPE))
MAPE_PremiMurni_Other_InvGauss_copula
...
MSE_Fire_Gamma
RMSE_Fire_Gamma=sqrt(MSE_Fire_Gamma)
...
MSE_Fire_Gaussian
RMSE_Fire_Gaussian=sqrt(MSE_Fire_Gaussian)
...
RMSE_Fire_Gaussian_log=sqrt(MSE_Fire_Gaussian_log)
...
RMSE_Fire_Inverse_Gaussian=sqrt(MSE_Fire_Inverse_Gaussian)
...
RMSE_copula_fire_testing_normal=sqrt(MSE_copula_fire_testing_normal)


#MAPE besar klaim fire
besarklaim_fire=data.frame(cbind(data_testing_Fire_subset$Sev_Fire, y_hat_Fire_Gamma,y_hat_Fire_Gaussian,y_hat_Fire_Gaussian_log,y_hat_Fire_Inverse_Gaussian,
                                 mean_testing_normal_fire))
filtered_besarklaim_fire_MAPE=subset(besarklaim_fire,besarklaim_fire$V1!=0)

MAPE_fire_Gamma=sum(abs((filtered_besarklaim_fire_MAPE$V1-filtered_besarklaim_fire_MAPE$y_hat_Fire_Gamma)/filtered_besarklaim_fire_MAPE$V1))*(1/nrow(filtered_besarklaim_fire_MAPE))
MAPE_fire_Gamma*100

MAPE_fire_Gaussian=sum(abs((filtered_besarklaim_fire_MAPE$V1-filtered_besarklaim_fire_MAPE$y_hat_Fire_Gaussian)/filtered_besarklaim_fire_MAPE$V1))*(1/nrow(filtered_besarklaim_fire_MAPE))
MAPE_fire_Gaussian*100

MAPE_fire_Gaussian_Log=sum(abs((filtered_besarklaim_fire_MAPE$V1-filtered_besarklaim_fire_MAPE$y_hat_Fire_Gaussian_log)/filtered_besarklaim_fire_MAPE$V1))*(1/nrow(filtered_besarklaim_fire_MAPE))
MAPE_fire_Gaussian_Log

MAPE_fire_InvGaussian_Log=sum(abs((filtered_besarklaim_fire_MAPE$V1-filtered_besarklaim_fire_MAPE$y_hat_Fire_Inverse_Gaussian)/filtered_besarklaim_fire_MAPE$V1))*(1/nrow(filtered_besarklaim_fire_MAPE))
MAPE_fire_InvGaussian_Log

MAPE_fire_InvGaussian_Log=sum(abs((filtered_besarklaim_fire_MAPE$V1-filtered_besarklaim_fire_MAPE$y_hat_Fire_Inverse_Gaussian)/filtered_besarklaim_fire_MAPE$V1))*(1/nrow(filtered_besarklaim_fire_MAPE))
MAPE_fire_InvGaussian_Log

MAPE_fire_copula_Normal=sum(abs((filtered_besarklaim_fire_MAPE$V1-filtered_besarklaim_fire_MAPE$mean_testing_normal_fire)/filtered_besarklaim_fire_MAPE$V1))*(1/nrow(filtered_besarklaim_fire_MAPE))
MAPE_fire_copula_Normal
...
RMSE_fire_GammaPoisson=sqrt(MSE_fire_GammaPoisson)
...
RMSE_fire_GaussianPoisson=sqrt(MSE_fire_GaussianPoisson)
...
RMSE_fire_GaussianPoisson_log=sqrt(MSE_fire_GaussianPoisson_log)
...
RMSE_fire_InverseGaussianPoisson=sqrt(MSE_fire_InverseGaussianPoisson)
...
RMSE_fire_NormalPoisson_copula=sqrt(MSE_fire_NormalPoisson_copula)

# MAPE Premi Murni Fire 
PremiMurni_Fire_MAPE=data.frame(cbind(S_fire, pure_prem_GammaPoisson_fire, pure_prem_GaussianPoisson_fire, pure_prem_GaussianPoisson_fire_log, 
                                       pure_prem_InverseGaussianPoisson_fire, pure_prem_copula_NormalPoisson_fire))
filtered_PremiMurni_fire_MAPE=subset(PremiMurni_Fire_MAPE,PremiMurni_Fire_MAPE$S_fire!=0)

MAPE_Fire_PurePrem_Gamma=sum(abs((filtered_PremiMurni_fire_MAPE$S_fire-filtered_PremiMurni_fire_MAPE$pure_prem_GammaPoisson_fire)/filtered_PremiMurni_fire_MAPE$S_fire))*(1/nrow(filtered_PremiMurni_fire_MAPE))
MAPE_Fire_PurePrem_Gamma

MAPE_Fire_PurePrem_Gaussian=sum(abs((filtered_PremiMurni_fire_MAPE$S_fire-filtered_PremiMurni_fire_MAPE$pure_prem_GaussianPoisson_fire)/filtered_PremiMurni_fire_MAPE$S_fire))*(1/nrow(filtered_PremiMurni_fire_MAPE))
MAPE_Fire_PurePrem_Gaussian

MAPE_Fire_PurePrem_Gaussian_Log=sum(abs((filtered_PremiMurni_fire_MAPE$S_fire-filtered_PremiMurni_fire_MAPE$pure_prem_GaussianPoisson_fire_log)/filtered_PremiMurni_fire_MAPE$S_fire))*(1/nrow(filtered_PremiMurni_fire_MAPE))
MAPE_Fire_PurePrem_Gaussian_Log

MAPE_Fire_PurePrem_InvGaussian=sum(abs((filtered_PremiMurni_fire_MAPE$S_fire-filtered_PremiMurni_fire_MAPE$pure_prem_InverseGaussianPoisson_fire)/filtered_PremiMurni_fire_MAPE$S_fire))*(1/nrow(filtered_PremiMurni_fire_MAPE))
MAPE_Fire_PurePrem_InvGaussian

MAPE_Fire_PurePrem_copula_Normal=sum(abs((filtered_PremiMurni_fire_MAPE$S_fire-filtered_PremiMurni_fire_MAPE$pure_prem_copula_NormalPoisson_fire)/filtered_PremiMurni_fire_MAPE$S_fire))*(1/nrow(filtered_PremiMurni_fire_MAPE))
MAPE_Fire_PurePrem_copula_Normal
...
#predict
# hasil prediksi !=0 namun data testing ada 0 
...
MSE_Theft_Gamma
RMSE_Theft_Gamma=sqrt(MSE_Theft_Gamma)
RMSE_Theft_Gamma
...
MSE_Theft_Gaussian
RMSE_Theft_Gaussian=sqrt(MSE_Theft_Gaussian)
RMSE_Theft_Gaussian
...
RMSE_Theft_Gaussian_log=sqrt(MSE_Theft_Gaussian_log)
RMSE_Theft_Gaussian_log
...
RMSE_Theft_InverseGaussian=sqrt(MSE_Theft_InverseGaussian)
RMSE_Theft_InverseGaussian
...
RMSE_copula_theft_testing_inv_gaussian=sqrt(MSE_copula_theft_testing_inv_gaussian)
RMSE_copula_theft_testing_inv_gaussian
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
# sev_theft dan beta
#model training 
...
RMSE_copula_theft_testing_inv_gaussian_beta=sqrt(MSE_copula_theft_testing_inv_gaussian_beta)

# Error besar klaim 
besarklaim_theft=data.frame(cbind(data_testing_Theft_subset$Sev_Theft,y_hat_Theft_Gamma,y_hat_Theft_Gaussian,y_hat_Theft_Gaussian_log,y_hat_Theft_Inverse_Gaussian,mean_testing_inv_gaussian_theft,mean_testing_inv_gaussian_theft_beta))
filtered_besarklaim_Theft=subset(besarklaim_theft,besarklaim_theft$V1==0)
MSE_Theft_Gamma01=sum((filtered_besarklaim_Theft$V1-filtered_besarklaim_Theft$y_hat_Theft_Gamma)^2)/nrow(filtered_besarklaim_Theft)
MSE_Theft_Gamma01
RMSE_Theft_Gamma01=sqrt(MSE_Theft_Gamma01)
RMSE_Theft_Gamma01

MSE_Theft_Gaussian01=sum((filtered_besarklaim_Theft$V1-filtered_besarklaim_Theft$y_hat_Theft_Gaussian)^2)/nrow(filtered_besarklaim_Theft)
MSE_Theft_Gaussian01
RMSE_MSE_Theft_Gaussian01=sqrt(MSE_Theft_Gaussian01)
RMSE_MSE_Theft_Gaussian01

MSE_Theft_Gaussian_log01=sum((filtered_besarklaim_Theft$V1-filtered_besarklaim_Theft$y_hat_Theft_Gaussian_log)^2)/nrow(filtered_besarklaim_Theft)
MSE_Theft_Gaussian_log01
RMSE_Theft_Gaussian_log01=sqrt(MSE_Theft_Gaussian_log01)
RMSE_Theft_Gaussian_log01

MSE_Theft_InvGaussian_log01=sum((filtered_besarklaim_Theft$V1-filtered_besarklaim_Theft$y_hat_Theft_Inverse_Gaussian)^2)/nrow(filtered_besarklaim_Theft)
MSE_Theft_InvGaussian_log01
RMSE_MSE_Theft_InvGaussian_log01=sqrt(MSE_Theft_InvGaussian_log01)
RMSE_MSE_Theft_InvGaussian_log01

MSE_Theft_copula_InvGauss01=sum((filtered_besarklaim_Theft$V1-filtered_besarklaim_Theft$mean_testing_inv_gaussian_theft)^2)/nrow(filtered_besarklaim_Theft)
MSE_Theft_copula_InvGauss01
RMSE_MSE_Theft_copula_InvGauss01=sqrt(MSE_Theft_copula_InvGauss01)
RMSE_MSE_Theft_copula_InvGauss01

MSE_Theft_copula_InvGauss_Beta01=sum((filtered_besarklaim_Theft$V1-filtered_besarklaim_Theft$mean_testing_inv_gaussian_theft_beta)^2)/nrow(filtered_besarklaim_Theft)
MSE_Theft_copula_InvGauss_Beta01
RMSE_MSE_Theft_copula_InvGauss_Beta01=sqrt(MSE_Theft_copula_InvGauss_Beta01)
RMSE_MSE_Theft_copula_InvGauss_Beta01

#MAPE besar klaim theft
filtered_besarklaim_Theft_MAPE=subset(besarklaim_theft,besarklaim_theft$V1!=0)

MAPE_Theft_Gamma=sum(abs((filtered_besarklaim_Theft_MAPE$V1-filtered_besarklaim_Theft_MAPE$y_hat_Theft_Gamma)/filtered_besarklaim_Theft_MAPE$V1))*(1/nrow(filtered_besarklaim_Theft_MAPE))
MAPE_Theft_Gamma

MAPE_Theft_Gaussian=sum(abs((filtered_besarklaim_Theft_MAPE$V1-filtered_besarklaim_Theft_MAPE$y_hat_Theft_Gaussian)/filtered_besarklaim_Theft_MAPE$V1))*(1/nrow(filtered_besarklaim_Theft_MAPE))
MAPE_Theft_Gaussian

MAPE_Theft_Gaussian_Log=sum(abs((filtered_besarklaim_Theft_MAPE$V1-filtered_besarklaim_Theft_MAPE$y_hat_Theft_Gaussian_log)/filtered_besarklaim_Theft_MAPE$V1))*(1/nrow(filtered_besarklaim_Theft_MAPE))
MAPE_Theft_Gaussian_Log

MAPE_Theft_InvGaussian_Log=sum(abs((filtered_besarklaim_Theft_MAPE$V1-filtered_besarklaim_Theft_MAPE$y_hat_Theft_Inverse_Gaussian)/filtered_besarklaim_Theft_MAPE$V1))*(1/nrow(filtered_besarklaim_Theft_MAPE))
MAPE_Theft_InvGaussian_Log

MAPE_Theft_copula_Inv_Gauss=sum(abs((filtered_besarklaim_Theft_MAPE$V1-filtered_besarklaim_Theft_MAPE$mean_testing_inv_gaussian_theft)/filtered_besarklaim_Theft_MAPE$V1))*(1/nrow(filtered_besarklaim_Theft_MAPE))
MAPE_Theft_copula_Inv_Gauss

MAPE_Theft_copula_Inv_Gauss_beta=sum(abs((filtered_besarklaim_Theft_MAPE$V1-filtered_besarklaim_Theft_MAPE$mean_testing_inv_gaussian_theft_beta)/filtered_besarklaim_Theft_MAPE$V1))*(1/nrow(filtered_besarklaim_Theft_MAPE))
MAPE_Theft_copula_Inv_Gauss_beta
...
Aktual_Prediksi=data.frame(cbind(S_Theft,pure_prem_GammaPoisson_Theft,pure_prem_GaussianPoisson_Theft,pure_prem_GaussianPoisson_Theft_log,pure_prem_InverseGaussianPoisson_Theft,
                      pure_prem_InverseGaussianPoisson_Theft_copula,pure_prem_InverseGaussianBeta_Theft_copula))
filtered_PremiMurni_Theft <- data.frame(subset(Aktual_Prediksi, Aktual_Prediksi$S_Theft==0))
MSE_Theft_GammaPoisson= sum((filtered_PremiMurni_Theft$S_Theft-filtered_PremiMurni_Theft$pure_prem_GammaPoisson_Theft)^2)/nrow(filtered_PremiMurni_Theft)
MSE_Theft_GammaPoisson
RMSE_Theft_GammaPoisson=sqrt(MSE_Theft_GammaPoisson)
RMSE_Theft_GammaPoisson

MSE_Theft_GaussianPoisson=sum((filtered_PremiMurni_Theft$S_Theft-filtered_PremiMurni_Theft$pure_prem_GaussianPoisson_Theft)^2)/nrow(filtered_PremiMurni_Theft)
MSE_Theft_GaussianPoisson
RMSE_Theft_GaussianPoisson=sqrt(MSE_Theft_GaussianPoisson)
RMSE_Theft_GaussianPoisson

MSE_Theft_GaussianPoisson_log=sum((filtered_PremiMurni_Theft$S_Theft-filtered_PremiMurni_Theft$pure_prem_GaussianPoisson_Theft_log)^2)/nrow(filtered_PremiMurni_Theft)
MSE_Theft_GaussianPoisson_log
RMSE_Theft_GaussianPoisson_log=sqrt(MSE_Theft_GaussianPoisson_log)
RMSE_Theft_GaussianPoisson_log

MSE_Theft_InverseGaussianPoisson=sum((filtered_PremiMurni_Theft$S_Theft-filtered_PremiMurni_Theft$pure_prem_InverseGaussianPoisson_Theft)^2)/nrow(filtered_PremiMurni_Theft)
MSE_Theft_InverseGaussianPoisson
RMSE_Theft_InverseGaussianPoisson=sqrt(MSE_Theft_InverseGaussianPoisson)
RMSE_Theft_InverseGaussianPoisson

MSE_Theft_InverseGaussianPoisson_copula=sum((filtered_PremiMurni_Theft$S_Theft-filtered_PremiMurni_Theft$pure_prem_InverseGaussianPoisson_Theft_copula)^2)/nrow(filtered_PremiMurni_Theft)
MSE_Theft_InverseGaussianPoisson_copula
RMSE_Theft_InverseGaussianPoisson_copula=sqrt(MSE_Theft_InverseGaussianPoisson_copula)
RMSE_Theft_InverseGaussianPoisson_copula

MSE_Theft_InverseGaussianBeta_copula=sum((filtered_PremiMurni_Theft$S_Theft-filtered_PremiMurni_Theft$pure_prem_InverseGaussianBeta_Theft_copula)^2)/nrow(filtered_PremiMurni_Theft)
MSE_Theft_InverseGaussianBeta_copula
RMSE_Theft_InverseGaussianBeta_copula=sqrt(MSE_Theft_InverseGaussianBeta_copula)
RMSE_Theft_InverseGaussianBeta_copula

#MAPE Premi Murni Theft 
filtered_PremiMurni_Theft_MAPE=subset(Aktual_Prediksi,Aktual_Prediksi$S_Theft!=0)
summary(filtered_PremiMurni_Theft_MAPE)

MAPE_PremiMurni_Theft_Gamma=sum(abs((filtered_PremiMurni_Theft_MAPE$S_Theft-filtered_PremiMurni_Theft_MAPE$pure_prem_GammaPoisson_Theft)/filtered_PremiMurni_Theft_MAPE$S_Theft))*(1/nrow(filtered_besarklaim_Theft_MAPE))
MAPE_PremiMurni_Theft_Gamma

MAPE_PremiMurni_Theft_Gaussian=sum(abs((filtered_PremiMurni_Theft_MAPE$S_Theft-filtered_PremiMurni_Theft_MAPE$pure_prem_GaussianPoisson_Theft)/filtered_PremiMurni_Theft_MAPE$S_Theft))*(1/nrow(filtered_PremiMurni_Theft_MAPE))
MAPE_PremiMurni_Theft_Gaussian

MAPE_PremiMurni_Theft_Gaussian_Log=sum(abs((filtered_PremiMurni_Theft_MAPE$S_Theft-filtered_PremiMurni_Theft_MAPE$pure_prem_GaussianPoisson_Theft_log)/filtered_PremiMurni_Theft_MAPE$S_Theft))*(1/nrow(filtered_PremiMurni_Theft_MAPE))
MAPE_PremiMurni_Theft_Gaussian_Log

MAPE_PremiMurni_Theft_InvGaussian=sum(abs((filtered_PremiMurni_Theft_MAPE$S_Theft-filtered_PremiMurni_Theft_MAPE$pure_prem_InverseGaussianPoisson_Theft)/filtered_PremiMurni_Theft_MAPE$S_Theft))*(1/nrow(filtered_PremiMurni_Theft_MAPE))
MAPE_PremiMurni_Theft_InvGaussian

MAPE_PremiMurni_Theft_copula_InvGaussian=sum(abs((filtered_PremiMurni_Theft_MAPE$S_Theft-filtered_PremiMurni_Theft_MAPE$pure_prem_InverseGaussianPoisson_Theft_copula)/filtered_PremiMurni_Theft_MAPE$S_Theft))*(1/nrow(filtered_PremiMurni_Theft_MAPE))
MAPE_PremiMurni_Theft_copula_InvGaussian

MAPE_PremiMurni_Theft_copula_InvGaussian_Beta=sum(abs((filtered_PremiMurni_Theft_MAPE$S_Theft-filtered_PremiMurni_Theft_MAPE$pure_prem_InverseGaussianBeta_Theft_copula)/filtered_PremiMurni_Theft_MAPE$S_Theft))*(1/nrow(filtered_PremiMurni_Theft_MAPE))
MAPE_PremiMurni_Theft_copula_InvGaussian_Beta
...
summary(mod2_Total_log) 
step_mod2_Total_log=stepAIC(mod2_Total_log,direction = "both")
summary(step_mod2_Total_log)


#family=inverse.gaussian(link="log")
mod3_Total=glm(Sev_Total~Channel+DrivAge+BonusMalus,family = inverse.gaussian(link="log"),data = data_training_Total_subset)
summary(mod3_Total) # 
...
MSE_Total_Gamma
RMSE_Total_Gamma=sqrt(MSE_Total_Gamma)
RMSE_Total_Gamma
...
MSE_Total_Gaussian
RMSE_Total_Gaussian=sqrt(MSE_Total_Gaussian)
RMSE_Total_Gaussian
...
RMSE_Total_Gaussian_Log=sqrt(MSE_Total_Gaussian_Log)
RMSE_Total_Gaussian_Log
...
RMSE_Total_inverse_Gaussian=sqrt(MSE_Total_inverse_Gaussian)
RMSE_Total_inverse_Gaussian

# MAPE besar klaim total 
# copula
u_training_total_inv_gaussian=pobs(data_training_Total_subset[c(22,12)])
...
for(j in 1:nrow(data_training_Total_subset)){
  ...
  for (i in 1:100){
    #ini untuk cari vi* dimana vi* adalah CDF inverse normal dari x1 dan x2
    v1_DrivAge_training[j]=qnorm(pgamma(data_training_Total_subset$DrivAge[j],shape = 11.6,scale=3.4139),0,1,lower.tail = TRUE)
    
    # matrix baris dari v*  
    v_mat_total_training[j,1]<-v1_DrivAge_training[j]
    ...
    # pdf(y) yang digunakan disini adalah inverse gaussian 
    random_inv_gaussian=rinvgauss(nrow(data_training_Total_subset),mean =1124.6,shape=45.351)
    
    y_total_training_inv_gaussian[j]=qnorm(pinvgauss(random_inv_gaussian[j],mean =1124.6,shape=45.351),0,1)
    
    # q disini merupakan pdf dari y|x1,x
    q_total_training_inv_gaussian[j]=(dinvgauss(random_inv_gaussian[j],mean =1124.6,shape=45.351))*exp(-0.5*(((y_total_training_inv_gaussian[j]-b_total_training_inv_gaussian[j])^2/a_total_training)-(y_total_training_inv_gaussian[j])^2))*(a_total_training)^(-0.5)
...
for(j in 1:nrow(data_testing_Total_subset)){
  for (i in 1:450){
    #ini untuk cari vi* dimana vi* adalah CDF inverse normal dari x1 dan x2
    v1_DrivAge_testing[j]=qnorm(pgamma(data_testing_Total_subset$DrivAge[j],shape = 11.6,scale=3.4139),0,1,lower.tail = TRUE)
    
    # matrix baris dari v*  
    v_mat_total_testing[j,1]<-v1_DrivAge_testing[j]
    ...
    # pdf(y) yang digunakan disini adalah inverse gaussian 
    random_inv_gaussian=rinvgauss(nrow(data_testing_Total_subset),mean =1124.6,shape=45.351)
    
    y_total_testing_inv_gaussian[j]=qnorm(pinvgauss(random_inv_gaussian[j],mean =1124.6,shape=45.351),0,1)
    
    # q disini merupakan pdf dari y|x1,x
    q_total_testing_inv_gaussian[j]=(dinvgauss(random_inv_gaussian[j],mean =1124.6,shape=45.351))*exp(-0.5*(((y_total_testing_inv_gaussian[j]-b_total_testing_inv_gaussian[j])^2/a_total_testing)-(y_total_testing_inv_gaussian[j])^2))*(a_total_testing)^(-0.5)
...
# MSE Premi Murni 
  ...
  RMSE_Total_GammaPoisson=sqrt(MSE_Total_GammaPoisson)
  RMSE_Total_GammaPoisson
  ...
  RMSE_Total_GaussianPoisson=sqrt(MSE_Total_GaussianPoisson)
  RMSE_Total_GaussianPoisson
  ...
  RMSE_Total_GaussianPoisson_log=sqrt(MSE_Total_GaussianPoisson_log)
  RMSE_Total_GaussianPoisson_log
  ...
  RMSE_Total_InverseGaussianPoisson=sqrt(MSE_Total_InverseGaussianPoisson)
  RMSE_Total_InverseGaussianPoisson
  ...
  RMSE_Total_InverseGaussianPoisson_copula=sqrt(MSE_Total_InverseGaussianPoisson_copula)
  RMSE_Total_InverseGaussianPoisson_copula
  
  # MAPE Premi Murni Total 
  PremiMurni_Total_MAPE=data.frame(cbind(S_Total, pure_prem_GammaPoisson_Total, pure_prem_GaussianPoisson_Total, pure_prem_GaussianPoisson_Total_log,
                                             pure_prem_InverseGaussianPoisson_Total,mean_testing_inv_gaussian_total))
  filtered_PremiMurni_Total_MAPE=subset(PremiMurni_Total_MAPE,PremiMurni_Total_MAPE$S_Total!=0)
  MAPE_Total_Pureprem_Gamma=sum(abs((filtered_PremiMurni_Total_MAPE$S_Total-filtered_PremiMurni_Total_MAPE$pure_prem_GammaPoisson_Total)/filtered_PremiMurni_Total_MAPE$S_Total))*(1/nrow(filtered_PremiMurni_Total_MAPE))
  MAPE_Total_Pureprem_Gamma
  
  MAPE_Total_Pureprem_Gaussian=sum(abs((filtered_PremiMurni_Total_MAPE$S_Total-filtered_PremiMurni_Total_MAPE$pure_prem_GaussianPoisson_Total)/filtered_PremiMurni_Total_MAPE$S_Total))*(1/nrow(filtered_PremiMurni_Total_MAPE))
  MAPE_Total_Pureprem_Gaussian
  
  MAPE_Total_Pureprem_Gaussian_Log=sum(abs((filtered_PremiMurni_Total_MAPE$S_Total-filtered_PremiMurni_Total_MAPE$pure_prem_GaussianPoisson_Total_log)/filtered_PremiMurni_Total_MAPE$S_Total))*(1/nrow(filtered_PremiMurni_Total_MAPE))
  MAPE_Total_Pureprem_Gaussian_Log
  
  MAPE_Total_Pureprem_InvGaussian=sum(abs((filtered_PremiMurni_Total_MAPE$S_Total-filtered_PremiMurni_Total_MAPE$pure_prem_InverseGaussianPoisson_Total)/filtered_PremiMurni_Total_MAPE$S_Total))*(1/nrow(filtered_PremiMurni_Total_MAPE))
  MAPE_Total_Pureprem_InvGaussian
  
  MAPE_copula_Total_Pureprem_InvGaussian=sum(abs((filtered_PremiMurni_Total_MAPE$S_Total-filtered_PremiMurni_Total_MAPE$mean_testing_inv_gaussian_total)/filtered_PremiMurni_Total_MAPE$S_Total))*(1/nrow(filtered_PremiMurni_Total_MAPE))
  MAPE_copula_Total_Pureprem_InvGaussian
  ...
  premi_murni_total=data.frame(cbind(S_Total,pure_prem_GammaPoisson_Total,pure_prem_GaussianPoisson_Total, pure_prem_GaussianPoisson_Total_log,pure_prem_InverseGaussianPoisson_Total
                                     ,pure_prem_InverseGaussianPoisson_Total_copula))
...
# boxplot premi murni data total dan dibagi beberapa jenis jaminan 
  premi_murni_total_individual=data.frame(cbind(S_Total,pure_prem_GammaPoisson_Total,pure_prem_GaussianPoisson_Total, pure_prem_GaussianPoisson_Total_log,pure_prem_InverseGaussianPoisson_Total
                                     ,pure_prem_InverseGaussianPoisson_Total_copula,pure_prem_Total_GLM_individual,pure_prem_Total_Copula_Individual))
  colnames(premi_murni_total_individual) <- c("Data", "Pois &\n Gamma", "Pois & \nNormal", "Pois & \nNormal Log","Pois & Inverse \nGaussian",
                                              "Pois & Inverse \nGaussian - Gamma Copula","Total Univariat GLM", "Total Univariat Copula")
